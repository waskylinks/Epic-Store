...
class BigQuery extends common_1.Service {
    ...
    static getTypeDescriptorFromProvidedType_(providedType) {
        ...
        else if (providedType.toUpperCase() === 'TIMESTAMP(12)') {
    ...
    buildQueryRequest_(query, options) {
        ...
        const hasAnyFormatOpts = options['formatOptions.timestampOutputFormat'] !== undefined ||
...
value, options) {
    ...
    switch (schemaField.type) {
        ...
        case 'TIMESTAMP': {
            ...
            const timestampOutputFormat = listParams?.['formatOptions.timestampOutputFormat'];
            ...
            else if (useInt64Timestamp !== true &&
        ...
        case 'RANGE': {
            value = BigQueryRange.fromSchemaValue_(value, schemaField.rangeElementType.type, options.listParams);
            break;
        }
        default:
            break;
...
class BigQueryRange {
     ...
     */
    static fromSchemaValue_(value, elementType, listParams) {
        const [start, end] = BigQueryRange.fromStringValue_(value);
